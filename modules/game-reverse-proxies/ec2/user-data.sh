...
echo "Starting game reverse proxy setup..."
...
echo "Creating systemd service for game proxy..."
cat > /etc/systemd/system/game-proxy.service <<EOF
[Unit]
Description=Game UDP Reverse Proxy
...
echo "Starting game proxy service..."
systemctl daemon-reload
systemctl enable game-proxy.service
systemctl start game-proxy.service

# Verify service status
echo "Checking service status..."
systemctl status game-proxy.service --no-pager

echo "Game reverse proxy setup complete!"
